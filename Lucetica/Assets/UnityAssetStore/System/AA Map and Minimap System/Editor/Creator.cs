...
namespace AAMAP
{
    public static class Creator
    {
        ...
        private static readonly string existingMaterialName = "Assets/UnityAssetStore/System/AA Map and Minimap System/Example Material/Example_Icon_Material.mat";
        private static readonly string materialsPath = "Assets/UnityAssetStore/System/AA Map and Minimap System/Materials";
        private static readonly string materialsFileNameFormat = "Map_Icon_Material";

        private static readonly string mapRenderTexturePath = "Assets/UnityAssetStore/System/AA Map and Minimap System/Render Textures/Map Render Textures";
        ...
        private static readonly string minimapRenderTexturePath = "Assets/UnityAssetStore/System/AA Map and Minimap System/Render Textures/Minimap Render Textures";
        ...
        public static void CreateMinimap()
        {
            ...
            else
            {
                ...
                {
                    minimapUIObject = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/UnityAssetStore/System/AA Map and Minimap System/Prefabs/Minimap.prefab"));
                    ...
                    if (minimapUIObject != null)
                    {
                        ...
                        minimapCamera = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/UnityAssetStore/System/AA Map and Minimap System/Prefabs/Minimap Camera.prefab"));
        ...
        public static void CreateMap()
        {
            ...
            else
            {
                ...
                {
                    mapUIObject = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/UnityAssetStore/System/AA Map and Minimap System/Prefabs/Map.prefab"));
                    ...
                    if (mapUIObject != null)
                    {
                        ...
                        mapCamera = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/UnityAssetStore/System/AA Map and Minimap System/Prefabs/Map Camera.prefab"));
        ...
        public static void CreateIcon()
        {
            ...
            GameObject createdIcon = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/UnityAssetStore/System/AA Map and Minimap System/Prefabs/Map Icon.prefab"));
        ...
        private static string CreateIconMaterialName()
        {
            ...
            {
                AssetDatabase.CreateFolder("Assets/UnityAssetStore/System/AA Map and Minimap System", "Materials");
            }
        ...
        private static string CreateMapRenderTextureName()
        {
            ...
            {
                AssetDatabase.CreateFolder("Assets/UnityAssetStore/System/AA Map and Minimap System/Render Textures", "Map Render Textures");
            }
        ...
        private static string CreateMinimapRenderTextureName()
        {
            ...
            {
                AssetDatabase.CreateFolder("Assets/UnityAssetStore/System/AA Map and Minimap System/Render Textures", "Minimap Render Textures");
            }
